...
export async function browserChecks(browser,url='http://127.0.0.1:4173/'){
 ...
 await page.goto(url);await page.evaluate(()=>localStorage.removeItem('shadowline-war-v1'));await page.reload();await page.setViewportSize({width:390,height:844});
