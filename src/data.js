...
export const MAPS=[
 {id:'duel',name:'双都对峙',subtitle:'5 个据点 · 快速交锋',desc:'两座首都隔着中央城镇相望。争夺侧翼油田，直取敌方指挥部。',factions:['北境联合','南境联盟','自由军团','秩序同盟'],fields:[
 ...
 {id:'rift',name:'裂谷防线',subtitle:'7 个据点 · 双线突破',desc:'两条进军路线穿过峡谷。控制中继站，撕开对方防线。',factions:['峡谷守军','高原军团','联合远征军','边境卫队'],fields:[
 ...
 {id:'ring',name:'灰烬环岛',subtitle:'9 个据点 · 环线包抄',desc:'环岛道路与中央堡垒相连。选择正面突破，或沿海岸迂回。',factions:['苍海舰队','赤潮军团','环岛民兵','铁幕旅团'],fields:[
 ...
 {id:'eastern_front',name:'东线纵深',subtitle:'14 个据点 · 纵深推进',desc:'以苏德战场的城市、铁路与南北战线为灵感。北线港口、中部交通轴和南部油区形成三条彼此支援的推进路线。',factions:['东部集团军','西方远征军','北方方面军','南方军区'],fields:[
 ...
 {id:'korea',name:'半岛拉锯',subtitle:'11 个据点 · 山地与港口',desc:'以朝鲜半岛的狭长地形为灵感。东西海岸线由山地走廊切开，仁川与元山提供侧翼通道，首尔是全图关键枢纽。',factions:['北方集团军','南方联合军','半岛防卫军','海峡远征军'],seaLinks:[['incheon','wonsan']],fields:[
 ...
 {id:'western_front',name:'法德西线',subtitle:'12 个据点 · 河谷突破',desc:'以法国战役方向的低地、阿登和莱茵交通网为灵感。北部港区适合迂回，中部要塞密集，南部路线更长但防线较薄。',factions:['莱茵集团军','西方联军','低地守备军','中央预备军'],seaLinks:[['belgium','hamburg']],fields:[
 ...
 {id:'hormuz',name:'霍尔木兹海峡',subtitle:'10 个据点 · 海峡封锁',desc:'围绕海峡、岛屿与油港展开争夺。陆上走廊稳定，跨海登陆更难形成决定性牌型。',factions:['海峡联合舰队','波斯湾卫队','海湾远征军','沿岸防卫军'],seaLinks:[['musandam','qeshm'],['gulf_port','qeshm']],fields:[
 ...
 {id:'china_civil_war',name:'山河决战',subtitle:'13 个据点 · 铁路与江河',desc:'以中国内战时期的铁路枢纽、山地与沿江城市为灵感。北方纵深与中部交通线决定南北两侧的推进节奏。',factions:['国民政府军','解放军','东北野战军','华中守备军'],fields:[
 f('nanjing','南京指挥部','capital',14,76,['xuzhou','wuhan','shanghai'],0,true),f('shanghai','上海港','port',27,88,['nanjing','hangzhou']),f('hangzhou','杭州','town',39,88,['shanghai','wuhan']),f('wuhan','武汉枢纽','town',34,66,['nanjing','hangzhou','xuzhou','zhengzhou','changsha','nanchang'],null,false,true),f('changsha','长沙','forest',37,85,['wuhan','nanchang']),f('nanchang','南昌','town',50,92,['changsha','wuhan']),f('xuzhou','徐州','town',25,52,['nanjing','wuhan','jinan','zhengzhou'],null,false,true),f('jinan','济南','town',34,35,['xuzhou','tianjin','zhengzhou'],null,false,true),f('tianjin','天津港','port',48,20,['jinan','beiping','shenyang']),f('beiping','北平枢纽','town',61,31,['tianjin','zhengzhou','yanan','shenyang'],null,false,true),f('zhengzhou','郑州','town',53,55,['wuhan','xuzhou','jinan','beiping','yanan'],null,false,true),f('yanan','延安指挥部','capital',74,48,['beiping','zhengzhou','shenyang'],1,true),f('shenyang','沈阳油区','oil',83,18,['tianjin','beiping','yanan'])]}
];
