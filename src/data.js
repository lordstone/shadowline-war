...
export const MAPS=[
 ...
 f('oman_hq','马斯喀特指挥部','capital',74,77,['gulf_port','musandam'],0,true),f('gulf_port','苏哈尔港','port',57,66,['oman_hq','musandam','island','qeshm','desert']),f('musandam','穆桑代姆','mountain',53,40,['oman_hq','gulf_port','island','qeshm','offshore']),f('island','海峡中岛','town',55,35,['gulf_port','musandam','qeshm','bandar'],null,false,true),f('qeshm','格什姆港','port',49,31,['gulf_port','musandam','island','bandar','iran_coast']),f('bandar','阿巴斯油港','oil',53,26,['island','qeshm','iran_hq','offshore']),f('iran_coast','沿岸山口','mountain',61,26,['qeshm','iran_hq','desert']),f('iran_hq','波斯湾指挥部','capital',39,35,['bandar','iran_coast'],1,true),f('offshore','外海锚地','port',50,49,['musandam','bandar']),f('desert','内陆沙漠','town',70,90,['gulf_port','iran_coast'],null,false)]},
