...
function mapView(){
 ...
 '<div class="target-actions">'+(s.actionSpent?'<span class="action-reminder" title="'+t('game.action.reminder_title')+'">'+t('game.action.reminder_text')+'</span>':'')+(f?.owner===null?btn(t('game.action.occupy')+' →','occupy','primary '+(primaryAvailable&&!placementValid?'needs-selection':''),!primaryAvailable||!can,'title="'+(placementValid?t('game.action.occupy_title_ok'):t('game.action.occupy_title_need'))+'" data-selection-ready="'+placementValid+'"'):f?.owner===1-p?btn(t('game.action.attack')+' →','attack','primary danger',!primaryAvailable||!can)+btn(t('game.action.siege',{cost:BALANCE.campaign.siegeCost}),'siege','secondary',!primaryAvailable||!can||f.garrison.length<=BALANCE.campaign.siegeThreshold||s.players[p].supply<BALANCE.campaign.siegeCost,'title="'+t('game.action.siege_title',{cost:BALANCE.campaign.siegeCost})+'"'):f?.owner===p?btn(t('game.action.reorganize')+' →','reorganize','primary '+(primaryAvailable&&!placementValid?'needs-selection':''),!primaryAvailable,'title="'+(placementValid?t('game.action.reorganize_title_ok'):t('game.action.reorganize_title_need'))+'" data-selection-ready="'+placementValid+'"')+btn(t('game.action.rotate',{cost:BALANCE.campaign.rotationCostPerCard}),'open-rotation','secondary',!actionable||!f.garrison.length||!s.players[p].hand.length||s.rapidRedeployUsed||s.players[p].supply<BALANCE.campaign.rotationCostPerCard,'title="'+t('game.action.rotate_title',{cost:BALANCE.campaign.rotationCostPerCard})+'"'):'')+
 btn(t('game.action.supply',{cost:BALANCE.campaign.resupplyCost,cards:BALANCE.campaign.resupplyCards}),'supply','secondary',!actionable||s.supplyUsed||s.players[p].supply<BALANCE.campaign.resupplyCost||s.deck.length<BALANCE.campaign.resupplyCards,'title="'+t('game.action.supply_title',{cost:BALANCE.campaign.resupplyCost,cards:BALANCE.campaign.resupplyCards})+'"')+btn(t('game.action.pass'),'pass','secondary pass-action',!actionable,'title="'+t('game.action.pass_title')+'"')+'</div></div></div>';
}
function line(p){
